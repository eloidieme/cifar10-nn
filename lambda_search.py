...
def main(seed):
    ...
    parser.add_argument('-nb', '--n-batches', dest='n_batch', type=int, default=450, help='Specify number of samples in one batch.')
    parser.add_argument('-ne', '--n-epochs', dest='n_epochs', type=int, default=12, help='Specify number of epochs.')
    
    args = parser.parse_args()

    gd_params = {"n_batch": args.n_batch, "n_epochs": args.n_epochs, "eta": 0}
    l_min, l_max = -4, -3
    lambdas = [6e-4, 6.25e-4, 6.5e-4, 6.75e-4, 7e-4]
